...
public class Jeopardy implements ActionListener {
	...
	public void run() {
		...
		JPanel panel = createHeader("      tech");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (firstButton.equals(buttonPressed)) {
			...
			askQuestion("when was the first i-pad released", "2010", 200);
			firstButton.setText("");
		}
		...
		if (secondButton.equals(buttonPressed)) {
			...
			askQuestion("when was the internet created", "1983", 400);
			secondButton.setText("");
		}
		
		if (thirdButton.equals(buttonPressed)) {
			askQuestion("what was the orginal name for windows", "interface manager", 600);
			thirdButton.setText("");
		}
		
		if (fourthButton.equals(buttonPressed)) {
			askQuestion("what were pcs called in the 1950s", "electronic brains", 800);
