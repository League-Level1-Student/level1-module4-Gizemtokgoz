...
public class SimonSays extends KeyAdapter {
	...
	public void run() {
		...
		JOptionPane.showMessageDialog(null,
				"Press the matching key when Simon says, or press a different key when he doesnt say Simon says.");
	...
	public void keyPressed(KeyEvent e) {
		...
		// say..."
			...
			point += 1;
			// 21. Use the speak method to tell the user they were not correct
			JOptionPane.showMessageDialog(null, "you are correct");
		}
